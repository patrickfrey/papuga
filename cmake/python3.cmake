...
string( REGEX REPLACE "^Python ([0-9]+[.][0-9]+)[.].*" "\\1"  PYTHON3_VERSION_MAIN_RELEASE  "${PYTHON3_VERSION}" )
else( ${PYVERSIONSTR}  STREQUAL  "Python 3" )
unset( PYTHON3_EXECUTABLE )
unset( PYTHON3_VERSION )
unset( PYTHON3_VERSION_MAIN_RELEASE )
...
if( ${RET_CFG} STREQUAL "" OR ${RET_CFG} STREQUAL "0" )
if( APPLE )
set( PYTHON3_LIBS  "-lpython${PYTHON3_VERSION_MAIN_RELEASE} ${PYTHON3_LIBS}" )
endif( APPLE )
MESSAGE( STATUS "---- DEBUG [1] PYTHON3_LIBS= ${PYTHON3_LIBS}" )
string( REGEX MATCHALL "-l[^ ]*" PYTHON3_LIBS  "${PYTHON3_LIBS}" )
MESSAGE( STATUS "---- DEBUG [2] PYTHON3_LIBS= ${PYTHON3_LIBS}" )
...
if( PYTHON3_VERSION )
MESSAGE( STATUS "Python 3.x version ${PYTHON3_VERSION}  (${PYTHON3_VERSION_MAIN_RELEASE})" )
