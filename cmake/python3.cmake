...
execute_process( COMMAND  brew ls python3
			   RESULT_VARIABLE  RET_PYTHON_PATH
			   OUTPUT_VARIABLE  PYTHON_INSTALL_PATH
			   OUTPUT_STRIP_TRAILING_WHITESPACE )
if( ${RET_PYTHON_PATH} STREQUAL "" OR ${RET_PYTHON_PATH} STREQUAL "0" )
MESSAGE( STATUS "Hint (brew ls) found to program path of python3: '${PYTHON_INSTALL_PATH}' " )
CHECK_PYTHON3_EXECUTABLE( ${RET_PYTHON_PATH} )
if( PYTHON3_EXECUTABLE )
break()
endif( PYTHON3_EXECUTABLE )
else( ${RET_PYTHON_PATH} STREQUAL "" OR ${RET_PYTHON_PATH} STREQUAL "0" )
MESSAGE( STATUS "Call 'brew ls python3' returns '${RET_PYTHON_PATH}' result '${PYTHON_INSTALL_PATH}' " )
endif( ${RET_PYTHON_PATH} STREQUAL "" OR ${RET_PYTHON_PATH} STREQUAL "0" )
