...
find_program( CANDIDATE NAME "${_prgname}" HINTS ${FINDPATH} )
if( CANDIDATE AND NOT CANDIDATE STREQUAL "CANDIDATE-NOTFOUND" )
CHECK_PHP7_EXECUTABLE( "${CANDIDATE}" )
endif( CANDIDATE AND NOT CANDIDATE STREQUAL "CANDIDATE-NOTFOUND" )
endif (NOT PHP7_EXECUTABLE)
