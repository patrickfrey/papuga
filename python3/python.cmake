...
execute_process( COMMAND  ${PYTHON_EXECUTABLE_ROOT}${PYVERSION}  ${CMAKE_CURRENT_SOURCE_DIR}/version.py
...
MESSAGE( STATUS "Call '${PYTHON_EXECUTABLE_ROOT}${PYVERSION}  ${CMAKE_CURRENT_BINARY_DIR}/version.py'  returns ${RET_PYVERSION} result ${OUT_PYVERSION}" )
...
MESSAGE( STATUS "Found Python 3.x executable ${PYTHON_EXECUTABLE_ROOT}${PYVERSION} but no libraries" )
